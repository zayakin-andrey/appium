...
exports.stopApp = function (req, res) {
  req.device.stopApp(getResponseHandler(req, res));
};
...
exports.broadcastIntent = function (req, res) {
  ...
  if (checkMissingParams(req, res, {intent: intent, receiver: receiver})) {
    req.device.broadcastIntent(intent, receiver, keys, getResponseHandler(req, res));
  }
};
